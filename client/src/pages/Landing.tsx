                ...
                <div className="mt-5 sm:mt-8 flex flex-col sm:flex-row sm:justify-center lg:justify-start gap-4">
                  ...
                  >
                    <Link href="/auth" className="block w-full">
                      <Button size="lg" variant="outline" className="w-full border-2 backdrop-blur-sm hover:bg-gradient-to-r from-primary to-primary/80 transition-all duration-300">
      ...
      <div className="relative">
        ...
        <div className="relative max-w-2xl mx-auto text-center py-16 px-4 sm:py-20 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="mt-4 text-lg leading-6 text-black/90">
